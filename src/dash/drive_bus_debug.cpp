...
static const vector<DebugField> debugFields = {
    ...
    // motor stats
    {"Motor_RPM",
     []() { return fmt("%0.2f", Resources::driveBusData().motorRPM); },
     []() { return fmt("%0.2f", Resources::prevDriveBusData().motorRPM); }},
    {"Motor_Curr",
     []() { return fmt("%0.2f", Resources::driveBusData().motorCurrent); },
     []() { return fmt("%0.2f", Resources::prevDriveBusData().motorCurrent); }},
    {"Motor_DC_V",
     []() { return fmt("%0.2f", Resources::driveBusData().motorDCVoltage); },
     []() { return fmt("%0.2f", Resources::prevDriveBusData().motorDCVoltage); }},
    {"Motor_DC_C",
