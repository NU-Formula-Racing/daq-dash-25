...
class DriveBus {
   ...
   private:
    ...
    CANTXMessage<3> tx_daq_lut_metadata{_driveBus, 0x2B0, 3, 100, timer_group, num_lut_pairs, interp_type, lut_id};
    ...
    CANTXMessage<4> tx_daq_lut_pair_zero_one{_driveBus, 0x2B1, 8, 100, timer_group, x_zero, y_zero, x_one, y_one};
    ...
    CANTXMessage<4> tx_daq_lut_pair_two_three{_driveBus, 0x2B2, 8, 100, timer_group, x_two, y_two, x_three, y_three};
    ...
    CANTXMessage<4> tx_daq_lut_pair_four_five{_driveBus, 0x2B3, 8, 100, timer_group, x_four, y_four, x_five, y_five};
    ...
    CANTXMessage<4> tx_daq_lut_pair_six_seven{_driveBus, 0x2B4, 8, 100, timer_group, x_six, y_six, x_seven, y_seven};
    ...
    CANTXMessage<4> tx_daq_lut_pair_eight_nine{_driveBus, 0x2B5, 8, 100, timer_group, x_eight, y_eight, x_nine, y_nine};
    ...
    CANTXMessage<4> tx_daq_lut_pair_ten_eleven{_driveBus, 0x2B6, 8, 100, timer_group, x_ten, y_ten, x_eleven, y_eleven};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twelve_thirteen{_driveBus, 0x2B7, 8, 100, timer_group, x_twelve, y_twelve, x_thirteen, y_thirteen};
    ...
    CANTXMessage<4> tx_daq_lut_pair_fourteen_fifteen{_driveBus, 0x2B8, 8, 100, timer_group, x_fourteen, y_fourteen, x_fifteen, y_fifteen};
    ...
    CANTXMessage<4> tx_daq_lut_pair_sixteen_seventeen{_driveBus, 0x2B9, 8, 100, timer_group, x_sixteen, y_sixteen, x_seventeen, y_seventeen};
    ...
    CANTXMessage<4> tx_daq_lut_pair_eighteen_nineteen{_driveBus, 0x2BA, 8, 100, timer_group, x_eighteen, y_eighteen, x_nineteen, y_nineteen};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twenty_twenty_one{_driveBus, 0x2BB, 8, 100, timer_group, x_twenty, y_twenty, x_twenty_one, y_twenty_one};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twenty_two_twenty_three{_driveBus, 0x2BC, 8, 100, timer_group, x_twenty_two, y_twenty_two, x_twenty_three, y_twenty_three};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twenty_four_twenty_five{_driveBus, 0x2BD, 8, 100, timer_group, x_twenty_four, y_twenty_four, x_twenty_five, y_twenty_five};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twenty_six_twenty_seven{_driveBus, 0x2BE, 8, 100, timer_group, x_twenty_six, y_twenty_six, x_twenty_seven, y_twenty_seven};
    ...
    CANTXMessage<4> tx_daq_lut_pair_twenty_eight_twenty_nine{_driveBus, 0x2BF, 8, 100, timer_group, x_twenty_eight, y_twenty_eight, x_twenty_nine, y_twenty_nine};
